...
using FrostySdk.Managers.Patch;
using FrostySdk.Managers.Loaders;
...
public static class AssetManager
{
    ...
    public static EbxAssetEntry? GetEbxEntry(string name) => GetEbxAssetEntry(name);
    ...
    public static EbxAssetEntry? GetEbxEntry(Guid guid) => GetEbxAssetEntry(guid);
    ...
    public static ChunkAssetEntry? GetChunkEntry(Guid chunkId)
    {
